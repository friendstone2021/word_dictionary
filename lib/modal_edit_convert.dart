...
class ModalEditConvert extends StatefulWidget{

  ModelGlossary? model;

  ModalEditConvert({super.key, this.model});

  @override
  State<StatefulWidget> createState() => ModalEditConvertState();

}

class ModalEditConvertState extends State<ModalEditConvert> {
